...
def draw_plots(df_optimize):
    histogram(df_optimize.loc[df_optimize['prof_classes_found'].isin(["specialist", "rukovoditel", "marketolog", "tester"])], "prof_classes_found")
    pie(df_optimize, "employment_name")
    linear_graphics(df_optimize, "salary_from", "salary_to")
    box(df_optimize, "schedule_id", "salary_to")
    correlation(df_optimize, ["salary_from", "salary_to", "address_lat", "address_lng"])

file_name = "H:/data/[4]vacancies.csv.gz"    
